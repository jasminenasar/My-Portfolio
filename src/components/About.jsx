...
function About(){
    return(
     ...
     <div className="about-container">
         ...
         <ul>
             <li><strong>NAME :</strong> Jasmine A </li>
             <li><strong>ROLE :</strong> Aspiring Frontend Developer</li>
             <li><strong>QUALIFICATION :</strong> B.sc.Mathematics</li>
             <li><strong>LOCATION :</strong> Tamil Nadu, India</li>
             <li><strong>EMAIL :</strong> jasminenasar15@gmail.com</li>
        ...
        <div className="about-content">
          ...
          <h3>1.Career Objective</h3>
          <p>To begin my career as a Frontend/Software Developer where I can apply my skills, continue learning, and contribute to real-world projects.</p>
          ...
          <ul>
             ...
             <li>Develop user friendly interfaces.</li>
             <li>Create projects using C , React and Java Script.</li>
